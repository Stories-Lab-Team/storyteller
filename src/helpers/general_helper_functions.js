...
export const callBacalhauJob = async (promptInput) => {
...
export const getImageBlob = async (
  status,
  setStatus,
  imageHTTPURL // this is the imageHTTPURL will just be ipfs://cid for normal image
) => {
...
export const getExampleImage = async (status, setStatus) => {
